package in.MyMart.config;

import in.MyMart.service.CustomUserService;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.inMemoryAuthentication().withUser("Abhijeet").password(passwordEncoder().encode("test@123"))
